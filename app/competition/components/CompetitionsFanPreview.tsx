...
export default function CompetitionsFanPreview() {
    ...
    const prizeSummary = useMemo(() => {
        ...
        return "Fixed prizes: Top 25 (1st ${cs()}7,500; 2nd ${cs()}5,000; 3rd ${cs()}2,500; 4th ${cs()}500; 5th ${cs()}300; 6–25 ${cs()}100). Tips are 90/10.";
    }, [fanCountPaid]);
                                        ...
                                        <Card className="p-5">
                                            ...
                                            <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3">
                                                ...
                                                <div className="rounded-xl border border-white/10 bg-black/30 p-3">
                                                    ...
                                                    <div className="text-sm text-gray-100 mt-1">{cs()}50</div>
                                                </div>
                                                <div className="rounded-xl border border-white/10 bg-black/30 p-3">
                                            ...
                                            <div className="mt-4 flex items-center gap-2">
                                                {!wallet.hasPaidEntry ? (
                                                    <Btn variant="gold" onClick={enterCompetition}>
                                                        <DollarSign className="w-4 h-4" /> Enter Competition {cs()}50
                                                    </Btn>
                                                ) : (
...
function DevTests() {
    useEffect(() => {
        ...
        assert("money(10)", money(10) === "${cs()}10");
        assert("money(10.2)", money(10.2) === "${cs()}10");
