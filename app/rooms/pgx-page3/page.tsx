        ...
        <div className="relative h-screen overflow-hidden fd-font-body fd-theme">
            ...
            <div className="relative z-10 flex flex-col h-screen">
                ...
                <header className="relative flex items-center justify-between px-5 py-1.5 border-b border-primary/20">
                    <button
                        className="flex items-center gap-2 px-3 py-1 rounded-full border border-primary/50 text-foreground/80 fd-font-body font-semibold text-sm hover:border-primary hover:text-foreground transition-all"
                ...
                <div className="px-4 py-2">
                    <div className="flex items-center justify-center gap-0 rounded-xl overflow-hidden fd-neon-border-md max-w-2xl mx-auto">
                        {bundles.map((bundle, i) => (
                            <div key={bundle.name} className="flex-1 flex flex-col items-center gap-0.5 px-4 py-2 relative">
                                ...
                                <button
                                    className="mt-1 px-6 py-1 rounded fd-font-tech font-bold text-sm text-white transition-all hover:scale-105"
                                    style={{
