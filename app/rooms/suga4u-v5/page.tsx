...
import PinnedOfferDrops from "@/components/rooms/suga4u-v5/PinnedOfferDrops";
import CreatorSecrets from "@/components/rooms/suga4u-v5/CreatorSecrets";
import LiveChat from "@/components/rooms/suga4u-v5/LiveChat";
import CreatorFavorites from "@/components/rooms/suga4u-v5/CreatorFavorites";
import PaidRequestMenu from "@/components/rooms/suga4u-v5/PaidRequestMenu";
import SendSugarGifts from "@/components/rooms/suga4u-v5/SendSugarGifts";
import QuickPaidActions from "@/components/rooms/suga4u-v5/QuickPaidActions";

const Index = () => {
    return (
        <div className="min-h-screen relative fd-suga4u-theme">
            {/* Full-screen background */}
            <div className="fixed inset-0 z-0">
                <img src="/images/rooms/suga/bg1.jpeg" alt="" className="w-full h-full object-cover" />
