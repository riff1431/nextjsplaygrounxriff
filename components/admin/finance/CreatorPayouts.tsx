            ...
            <div className="pgx-main">
                ...
                <div className="pgx-summary glass neon-pink">
                    <div className="flex flex-col">
                        ...
                        <span className="text-3xl font-bold text-white mt-1">{cs()}{Number(totals.total_creators_earned).toLocaleString()}</span>
                    </div>
                    <div className="h-8 w-[1px] bg-[var(--line)]"></div>
                    <div className="flex flex-col">
                        <span className="text-sm text-[var(--muted)]">Platform Revenue</span>
                        <span className="text-xl font-bold text-[var(--cyan)] mt-1">{cs()}{Number(totals.total_platform_earned).toLocaleString()}</span>
                    </div>
                    ...
                    <div className="pgx-table glass">
                        ...
                        {!loading && rows.map(row => (
                            ...
                            >
                                ...
                                <div className="td justify-end text-[var(--muted)]">{cs()}{row.gross_collected.toFixed(2)}</div>
                                <div className="td justify-end font-bold text-[var(--pink)]">{cs()}{row.creator_earned.toFixed(2)}</div>
                                <div className="td justify-end font-medium text-[var(--cyan)]">{cs()}{row.platform_earned.toFixed(2)}</div>
