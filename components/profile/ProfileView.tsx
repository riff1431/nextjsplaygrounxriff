                        ...
                        <div className="flex items-center gap-3 w-full md:w-auto mt-2 md:mt-0">
                            ...
                            {!(isOwner && profile.role !== 'creator') && (
                                <Button
                                    ...
                                    className="bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white rounded-full px-4 shadow-[0_0_18px_rgba(225,29,72,0.35)] border border-rose-400/20 font-semibold transition-all disabled:opacity-50"
