...
const NavBar = () => {
    return (
        <nav className="flex items-center justify-between px-4 py-3 border-b border-border bg-background/50 backdrop-blur-md">
            ...
            <div className="flex items-center gap-2">
                ...
                <h1 className="font-display text-xl font-bold tracking-wider neon-text-pink">
                    Confessions <span className="text-gold">X</span>
                </h1>
            </div>
            ...
            <div className="flex items-center gap-3">
                <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-full glass-card text-sm font-medium">
                    ...
                    <span className="text-gold font-semibold">{cs()}100</span>
