...
const Index = () => {
  return (
    <div
      className="min-h-screen bg-background bg-center bg-no-repeat relative"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto py-8 pt-48">
        ...
        {/* Main Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 lg:grid-rows-1">
          {/* Left Column */}
          <div className="lg:col-span-4 flex flex-col gap-6 lg:row-span-1">
           ...
           <div className="lg:col-span-2 ">
            <div className=" vote-btn lg:col-span-3 lg:row-span-3 rounded-lg mt-52 h-12  font-semibold flex items-center justify-center">
            Enter Room
            </div>
           </div>
          {/* Right Column */}
